...
<p>
  Puedes escribirnos directamente a <a href="mailto:contacto@kangarooaj.com">
  contacto@kangarooaj.com</a> o usar el formulario de la página de inicio para compartir más
  contexto de tu proyecto.
</p>
<p>
  A partir de ahí agendamos una sesión inicial donde:
</p>
<ul>
