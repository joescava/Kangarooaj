      ...
      <div className="grid min-w-0 gap-5 md:grid-cols-[minmax(0,1fr)_auto] md:items-center">
        <div>
          <h3 className="text-base font-semibold text-white">
            {isEnglish ? "Privacy & Cookie Preferences" : "Preferencias de privacidad y cookies"}
          </h3>
          ...
          {customize && (
            <div className="mt-4 grid gap-3 text-sm text-slate-300">
              <label className="flex items-center gap-3">
                <input type="checkbox" checked disabled className="h-4 w-4 accent-cyan-300" />
                {isEnglish ? "Necessary cookies always active" : "Cookies necesarias siempre activas"}
              </label>
        ...
        <div className="responsive-actions mobile-full-actions md:justify-end">
          ...
          <button
            type="button"
            onClick={() => persist(customize ? analytics : true, customize ? marketing : true)}
